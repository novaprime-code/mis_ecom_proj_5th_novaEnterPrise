...
foreach ($submissions as $index => $submission) {
    ...
    <div class="rm-submission-card">
        <div class="rm-submission-card-title dbfl">
            <a href="<?php echo esc_url(add_query_arg('submission_id', $submission_id, get_permalink(get_option('rm_option_front_sub_page_id')))); ?>" class="difl"><?php echo esc_html($submission->form_name); ?> </a>
        </div>

    ...
    <div class="dbfl rm-magic-popup-login">
        ...
        <div id="rm_otp_enter_password" style="display:none" class="rm_otp_after_email rm-mp-animationRight">
            ...
            <div class="dbfl rm-login-panel-fields">
                ...
                <div id="rm_rememberme_cb" class="dbfl"><div class="difl rm_cb"><input style="width:auto" type="checkbox" id="rm_rememberme" value="yes"><?php echo RM_UI_Strings::get('LABEL_REMEMBER'); ?></div><div class="difl rm_link"><a href="<?php echo esc_url($lostpassword_url); ?>" target="blank"><?php echo RM_UI_Strings::get('MSG_LOST_PASS'); ?></a></div></div>    
            </div>
        </div>
    </div>

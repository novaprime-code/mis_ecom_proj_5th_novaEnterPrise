...
<div class="rm-features-row">
    <div class="rm-feature-cell">
        <img src="<?php echo esc_url(RM_IMG_URL); ?>help.png">
    </div>
    ...
    <div class="rm-feature-cell">
        <img src="<?php echo esc_url(RM_IMG_URL); ?>next.png">
    </div>

</div>
<div class="rm-feature-content">
    <img src="<?php echo esc_url(RM_IMG_URL); ?>content-arrow.png" class="content-arrow">
...
<?php endif; ?>
    <img src="<?php echo esc_url(RM_EX_LMS()->base_url); ?>images/lm_sshot_fe_primer.jpg" class="content-asset">
</div>
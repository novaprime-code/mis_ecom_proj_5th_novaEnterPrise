...
//        /var_dump($this->_attributes);
        ...
        ?>  
    <div
         class="rateit rm_rating_face_<?php echo esc_attr($star_face); ?>"
         id="rm_rateit5"
         data-rateit-min="0"
         data-rateit-max="<?php echo esc_attr($max_stars); ?>"
         data-rateit-value="<?php echo esc_attr($this->getAttribute('value')); ?>"
         data-rateit-step="<?php echo esc_attr($step_size); ?>"
         data-rateit-ispreset="true"
         data-rateit-mode="font"
         data-rateit-icon="<?php echo esc_attr($star_icon); ?>"
         data-rateit-starwidth="<?php echo esc_attr($star_width); ?>"
         data-rateit-forcestarwidth="true"
         data-rateit-resetable="false"         
         <?php if($is_read_only): ?>            
            data-rateit-readonly="true"
         <?php else: ?>
            data-rateit-backingfld="#<?php echo esc_attr($id); ?>"
         <?php endif; ?>
         style="font-family:Material Icons;word-wrap:normal;color:#<?php echo esc_attr($star_color); ?>"
    >
    <?php if(!$is_read_only): ?>
        <input type="hidden" class="rateitbackend <?php echo esc_attr($this->getAttribute('class')); ?>" id="<?php echo esc_attr($id); ?>" name="<?php echo esc_attr($this->_attributes['id']); ?>" <?php echo esc_attr($req_attr); ?> value="<?php echo esc_attr($this->getAttribute('value')); ?>"/>
    <?php endif; ?>
</div>

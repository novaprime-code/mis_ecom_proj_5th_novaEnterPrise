...
<?php echo _e('Logged In View', 'custom-registration-form-builder-with-submission-manager'); ?>
        ...
        <div class="rm-logged-in-view rm-dbfl">
            <div class="rm-logged-in-view-wrap">
                <div class="rm-logged-in-lf rm-difl"> <img alt="" src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/default_person.png'); ?>" class="avatar avatar-96 photo" height="96" width="96"> </div>

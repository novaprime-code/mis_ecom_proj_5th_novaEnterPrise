...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Textbox(RM_UI_Strings::get('LABEL_FILE_PREFIX'), "buy_pro_2", array("value" => $data['file_prefix'], "id" => "id_rm_file_prefix", 'disabled' => 1, "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_GEN_FILE_PREFIX') . "<br><br>" . RM_UI_Strings::get('MSG_BUY_PRO_INLINE'))));
    
        $form->addElement(new Element_Number(RM_UI_Strings::get('LABEL_FILE_SIZE'), "buy_pro_3", array("value" => $data['file_size'],  "min" => 0, "id" => "id_rm_file_size", 'disabled' => 1, "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_GEN_FILE_SIZE') . "<br><br>" . RM_UI_Strings::get('MSG_BUY_PRO_INLINE'))));
    
        $form->addElement(new Element_Textbox(RM_UI_Strings::get('LABEL_FILE_SIZE_ERR'), "buy_pro_4", array("value" => $data['file_size_error'], "id" => "id_rm_file_size_err", 'disabled' => 1, "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_GEN_FILE_SIZE_ERR') . "<br><br>" . RM_UI_Strings::get('MSG_BUY_PRO_INLINE'))));

        $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_ALLOWED_MULTI_FILES'), "buy_pro_5", array("yes" => ''), array("value" => "no", 'disabled' => 1, "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_GEN_FILE_MULTIPLE') . "<br><br>" . RM_UI_Strings::get('MSG_BUY_PRO_INLINE'))));

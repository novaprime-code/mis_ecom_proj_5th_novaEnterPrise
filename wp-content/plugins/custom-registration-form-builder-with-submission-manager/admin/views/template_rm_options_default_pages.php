...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        if(class_exists('Profile_Magic')) {
            $form->addElement(new Element_Checkbox(__('Disable ProfileGrid Frontend Profile', 'custom-registration-form-builder-with-submission-manager'), "disable_pg_profile", array('yes' => ''), array("value" => $disable_pg_profile, "longDesc" => __("Use this option if you don't need the ProfileGrid frontend profile to display instead of the RegistrationMagic User Account page.",'custom-registration-form-builder-with-submission-manager'))));
        }

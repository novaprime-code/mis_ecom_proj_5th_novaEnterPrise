...
<div class="rm-sub-legends">    
    ...
    <div class="rm-sub-legends-row">
         ...
         <div class="rm-legend-wrap">
            <div class="rm-legend-img">   
                <img  class="rm_submission_icon" alt="" src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/blocked.png'); ?>"> <span class="rm-legend-text"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_LEGEND_USER_BLOCKED')); ?></span>
            </div>
         </div>
        
        <div class="rm-legend-wrap">
            <div class="rm-legend-img">   
                <img  class="rm_submission_icon" alt="" src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/note.png'); ?>"> <span class="rm-legend-text"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_LEGEND_NOTES')); ?></span>
            </div>
        </div>

        <div class="rm-legend-wrap">
            <div class="rm-legend-img">   
                <img  class="rm_submission_icon" alt="" src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/message.png'); ?>"> <span class="rm-legend-text"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_LEGEND_MESSAGE')); ?></span>
            </div>
        </div>

        <div class="rm-legend-wrap">
            <div class="rm-legend-img">   
                <img  class="rm_submission_icon" alt="" src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/attachment.png'); ?>"> <span class="rm-legend-text"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_LEGEND_ATTACHMENT')); ?></span>
            </div>
        </div>

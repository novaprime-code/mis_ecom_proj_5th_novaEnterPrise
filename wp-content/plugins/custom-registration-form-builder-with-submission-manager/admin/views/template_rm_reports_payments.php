...
if(defined('REGMAGIC_ADDON')) {
    include_once(RM_ADDON_ADMIN_DIR . 'views/template_rm_reports_payments.php');
}
else{
?>
    <div class="rmagic">
        <div class="rmagic-reports">
            <div class="rm-reports-dashboard">
                <h3><?php _e('Payments Reports','custom-registration-form-builder-with-submission-manager');?></h3>
            </div>

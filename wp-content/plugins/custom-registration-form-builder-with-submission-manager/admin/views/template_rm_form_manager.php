        ...
        <div class="operationsbar" id="rmbar">
            ...
            <div class="nav" id="rm-ob-nav">
                ...
                <!--<li id="rm-ob-new"><a href="<?php echo admin_url("admin.php?page=rm_form_setup");?>"><?php echo wp_kses_post(RM_UI_Strings::get('ADMIN_MENU_SETUP'));?></a></li>-->
                    ...
                    <li id="rm-ob-demo"><a target="_blank" href="https://registrationmagic.com/create-wordpress-registration-page-starter-guide/"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_STARTER_GUIDE')); ?><span class="dashicons dashicons-book-alt"></span></a></li> 

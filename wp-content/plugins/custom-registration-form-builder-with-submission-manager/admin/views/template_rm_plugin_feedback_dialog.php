                                ...
                                <div id="rm-deactivate-feedback-dialog-form-body">
                                    <?php foreach ($deactivate_reasons as $reason_key => $reason) : ?>
                                        <div class="rm-deactivate-feedback-dialog-input-wrapper">                                            
                                            ...
                                            <label for="rm-deactivate-feedback-<?php echo esc_attr($reason_key); ?>" class="rm-deactivate-feedback-dialog-label"><?php echo esc_html($reason['title']); ?></label>
                                            ...
                                            <?php if($reason['show_help_link']): ?>
                                                <div class="rminput" id="help_link_<?php echo esc_attr($reason_key); ?>" style="display:none">
                                                    <a class="rm_help_link" href="<?php echo esc_url($help_link); ?>" target="_blank"> <?php echo esc_html($reason['show_help_link']); ?> </a>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endforeach; ?>

...
class RM_User_Filter extends RM_Filter {
    ...
    public function get_records() {
       $this->records = $this->service->get_all_user_data($this->pagination->curr_page, $this->pagination->entries_per_page, $this->filters['rm_to_search'], $this->filters['rm_status'], $this->filters['rm_interval'], $this->filters['rm_sort']);
       return $this->records; 
    }

     public function set_pagination(){
        $total_entries=null;
        $total_entries = count($this->service->get_all_user_data(1, 99999999, $this->filters['rm_to_search'], $this->filters['rm_status'], $this->filters['rm_interval'], $this->filters['rm_sort']));
